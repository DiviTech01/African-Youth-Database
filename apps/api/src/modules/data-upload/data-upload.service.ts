...
export class DataUploadService {
  ...
  getTemplates() {
    // Per-theme upload templates align with the seven AYO themes. The
    // "full-ayims" template is the canonical AYIMS datasheet covering all 7.
    return [
      { slug: 'youth-demography-participation', name: 'Youth Demography & Participation', description: 'Population, voter turnout, parliamentary representation, civic participation', indicatorCount: 8, columns: ['Country', 'ISO3', 'Year', 'Total Population', 'Youth Population (15–35)', 'Youth % of Total', 'Youth Voter Turnout (%)', 'Youth Political Participation Index', 'Youth Seats in Parliament (%)', 'Youth Trust in Government Index', 'Freedom of Association Score'] },
      { slug: 'education', name: 'Education', description: 'Literacy, enrollment, dropout, completion, education spending', indicatorCount: 7, columns: ['Country', 'ISO3', 'Year', 'Youth Literacy Rate (%)', 'Primary Enrollment Rate (%)', 'Secondary Net Enrollment (%)', 'Tertiary Gross Enrollment (%)', 'School Dropout Rate (%)', 'Education Budget (% GDP)', 'Teacher–Student Ratio'] },
      { slug: 'employment', name: 'Employment', description: 'Unemployment, labour-force participation, sectoral split, informal employment', indicatorCount: 7, columns: ['Country', 'ISO3', 'Year', 'Youth Unemployment Rate (%)', 'Youth LFPR (%)', 'Employment-to-Population Ratio (%)', 'Youth/Adult Unemployment Ratio', 'Informal Employment Rate (%)', 'Youth in Agriculture (%)', 'Youth in Industry (%)', 'Youth in Services (%)'] },
      { slug: 'health', name: 'Health', description: 'Skilled births, contraception, HIV, mortality, mental health, health spending', indicatorCount: 10, columns: ['Country', 'ISO3', 'Year', 'Births by Skilled Staff (%)', 'Physician Density (per 10k)', 'Contraceptive Prevalence Youth (%)', 'HIV Prevalence Youth (%)', 'YPLWHA Treatment Rate (%)', 'Youth Suicide Rate (per 100k)', 'Maternal Mortality Ratio', 'Health Budget (% of Nat. Budget)'] },
      { slug: 'entrepreneurship', name: 'Entrepreneurship', description: 'Startup survival, microcredit, IP, credit access, digital infrastructure', indicatorCount: 9, columns: ['Country', 'ISO3', 'Year', 'Youth Startup Survival Rate (%)', 'Youth Microcredit Recipients (000s)', 'Internet Access % Households', 'Getting Credit Rank (WB)', 'Protecting Investors Rank (WB)', 'Youth IP Registrations', 'Mobile Money Penetration (%)', 'Financial Literacy Rate (%)'] },
      { slug: 'peace-security', name: 'Peace & Security', description: 'Displacement, trafficking, deaths from violent extremism', indicatorCount: 3, columns: ['Country', 'ISO3', 'Year', 'Youth IDPs (18–30)', 'Trafficking Victims (18–30)', 'Deaths from Violent Extremism (18–35)'] },
      { slug: 'access-to-justice', name: 'Access to Justice', description: 'Pre-trial backlog, incarceration, juvenile detention', indicatorCount: 3, columns: ['Country', 'ISO3', 'Year', 'Youth Awaiting Trial', 'Youth Imprisoned', 'Juvenile Detentions'] },
      { slug: 'full-ayims', name: 'Full AYIMS Format (AU Commission)', description: 'Complete 51-indicator AYIMS datasheet — all 7 themes in one file', indicatorCount: 51, columns: ['Country', 'Year', '...all 51 AYIMS columns covering Demography & Participation, Education, Employment, Health, Entrepreneurship, Peace & Security, Access to Justice'] },
    ];
  }
